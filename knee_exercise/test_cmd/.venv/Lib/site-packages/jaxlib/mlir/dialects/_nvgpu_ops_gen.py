...
def device_async_copy(dst, dst_indices, src, src_indices, dst_elements, *, src_elements=None, bypass_l1=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(DeviceAsyncCopyOp(dst=dst, dstIndices=dst_indices, src=src, srcIndices=src_indices, dstElements=dst_elements, srcElements=src_elements, bypassL1=bypass_l1, loc=loc, ip=ip))
...
def device_async_create_group(input_tokens, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(DeviceAsyncCreateGroupOp(inputTokens=input_tokens, loc=loc, ip=ip))
...
def mbarrier_arrive_nocomplete(barriers, mbar_id, count, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MBarrierArriveNoCompleteOp(barriers=barriers, mbarId=mbar_id, count=count, loc=loc, ip=ip))
...
def mbarrier_arrive(barriers, mbar_id, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MBarrierArriveOp(barriers=barriers, mbarId=mbar_id, loc=loc, ip=ip))
...
def mbarrier_test_wait(barriers, token, mbar_id, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MBarrierTestWaitOp(barriers=barriers, token=token, mbarId=mbar_id, loc=loc, ip=ip))
...
def rcp(in_, *, rounding=None, ftz=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(RcpOp(in_=in_, rounding=rounding, ftz=ftz, loc=loc, ip=ip))
